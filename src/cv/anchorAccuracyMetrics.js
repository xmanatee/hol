...
const sortedSuccessfulAnchorErrors = (frames) =>
  frames
    .filter((frame) => frame.success && frame.targetPresent !== false && Number.isFinite(frame.anchorError))
...
export const anchorAccuracyMetrics = (frames) =>
  Object.fromEntries(
    ANCHOR_ACCURACY_THRESHOLDS.map((threshold) => [
